...
def dfs(source, destination, verbose=True):
    ...
    while frontier:
        route = frontier.pop()  # LIFO stack behavior for Depth-First Search
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 3:
        ...
        print("=" * 70)
        print(" DEPTH FIRST SEARCH (DFS) - 15 RANDOM INITIAL & FINAL STATES")
        print("=" * 70)
